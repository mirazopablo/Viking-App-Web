...
import { BudgetDocumentHeader } from './BudgetDocumentHeader';
import { BudgetDocumentBlocks } from './BudgetDocumentBlocks';
import { BudgetDocumentTable } from './BudgetDocumentTable';
import { PrintableBudgetDocument } from './PrintableBudgetDocument';
import { Card, CardContent } from '@/components/ui/card';
import { Button } from '@/components/ui/button';
import { Eye, ShieldAlert, Printer } from 'lucide-react';

interface BudgetLivePreviewProps {
  staffName?: string;
}

export const BudgetLivePreview: React.FC<BudgetLivePreviewProps> = ({ staffName }) => {
  const { watch } = useFormContext<BudgetFormSchemaType>();
